...
{
    public sealed class QuickInjectContainerAdapter : ContainerAdapterBase
    {
        private QuickInjectContainer container;

        public override string PackageName
        {
            get { return "QuickInject"; }
        }

        public override string Url
        {
            get { return "https://github.com/isabgol/QuickInject"; }
        }
    ...
    public class QuickInjectChildContainerAdapter : IChildContainerAdapter
    {
        private IUnityContainer childContainer;

        public QuickInjectChildContainerAdapter(IUnityContainer childContainer)
        {
