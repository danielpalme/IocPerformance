...
namespace IocPerformance.Adapters
{
	public sealed class GriffinContainerAdapter : ContainerAdapterBase
	{
		...
		// It says it supports property injection but there is no documentation on how to turn it on
		// and it doesn't work out of the box so ... it's turned off
		...
		private static void RegisterPropertyInjection(ContainerRegistrar registrar)
		{
			...
			registrar.RegisterService<IComplexPropertyObject>(x => new ComplexPropertyObject
				                                                       {
